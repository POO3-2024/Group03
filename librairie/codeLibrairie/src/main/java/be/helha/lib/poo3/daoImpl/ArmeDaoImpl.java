...
public class ArmeDaoImpl implements ArmeDao {
     ...
     * @return l'arme correspondante, ou null si aucune arme n'est trouvée
     */
    public Armes getArmeID(String id){
        Armes armes = null;
        Connection con = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
