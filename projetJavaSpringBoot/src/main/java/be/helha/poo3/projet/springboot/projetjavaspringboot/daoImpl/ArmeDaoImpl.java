...
import be.helha.poo3.projet.springboot.projetjavaspringboot.dao.ArmeDao;
import be.helha.poo3.projet.springboot.projetjavaspringboot.domaine.Armes;


public class ArmeDaoImpl implements ArmeDao {
    private static final String GET = "SELECT * FROM arme b WHERE b.ID = ?";
    ...
    public Armes getArme(String id){
        Armes armes = null;
        Connection con = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            if(rs.next()){
                ...
                System.out.println("Aucune arme trouvé avec l'identifiant " + id);
            }
        } catch (Exception e) {
